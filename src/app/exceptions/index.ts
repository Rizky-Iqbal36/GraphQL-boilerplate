...
class BaseException extends ApolloError {
  constructor(code: string, private readonly messageOption: IMessageOption, extension?: IExtension) {
...
export class InternalServerError extends BaseException {
  constructor(details?: IExtension) {
    super('INTERNAL_SERVER_ERROR', { localeMessage: { key: 'INTERNAL_SERVER_ERROR' } }, details)
  }
}
