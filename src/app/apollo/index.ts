...
import { ApolloServer, ApolloServerFastifyConfig as ApolloConfig } from 'apollo-server-fastify'
import { GraphQLError, GraphQLFormattedError } from 'graphql'
import { GraphQLContext } from '@root/interfaces'
import { FastifyRequest, FastifyReply } from 'fastify'

export type FormatError = (graphQLError: GraphQLError, context: GraphQLContext) => GraphQLFormattedError
...
export class CustomApolloServer extends ApolloServer {
  ...
  async createGraphQLServerOptions(req: FastifyRequest, rep: FastifyReply): Promise<GraphQLServerOptions> {
